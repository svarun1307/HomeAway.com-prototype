                ...
                if(response.status === 200){
                    ...
                    try
                    {
                        ...
                        else if(s["code"]=="+1")
                        {
                            ...
                            window.jQuery("#exampleModal .modal-body").html("You have registered successfully to HomeAway as a seller!<br/>Please login once to proceed.");
                            window.jQuery("#exampleModal .modal-footer").html('<button type="button" class="btn btn-success" onclick=gotoLogin(\'S\') >Proceed</button>');
                ...
                <div className="container loginContainer fullHeight">
                    <div className="loginHeader row justify-content-md-center ">
                        <div className="col col-lg-7 text-center" style={lowerMargin}>
                            ...
                            <h6 className="smaller" style={smallerHeadingSingup} >Already have an account? <Link className="signupref" href="javascript:void(0)" to="/seller-login"> Login</Link> </h6>
