...
class SellerQuestions extends Component {
    ...
    componentDidMount()
    {
        ...
        let _s = this;
        let u = { userkey : sessionStorage.getItem('user-token'), usertype : "SELLER"};
        console.log(u);
            ...
            <div>
                ...
                <div className="container">
                    <div className="col-lg-12"><div className="col-lg-12">
                        <h2 className="mybookingsheader">User Questions Received<hr/></h2>
                                             
                        {
                             ...
                             this.state.placesArraySellerWithQuestions && this.state.placesArraySellerWithQuestions.map((player,i) => {  
                                ...
                                return (
                                    <div>
                                        <PropertyComponents key={i} propertyInfo={player}  />
                                                   <div className="row">
                                                    
                                                    <div className="col-lg-12">                                  
                                                        <div><h4 className="qnsprop">Questions for this property:</h4></div>
                                                    </div>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-10 row">
                                                    {
                                                        ...
                                                        player.questions.map((data2,i2)=>{
                                                                return <QuestionAnswers usertype="SELLER"  qndata={data2}looper={i2}></QuestionAnswers>
                                                            })                                    
                                                        }  
                                                    </div>
                                                </div>
