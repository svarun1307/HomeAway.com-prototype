...
class TravellerDashBoardHeader extends React.Component {
    ...
    constructor(props)
    {
        ...
        {
            if(sessionStorage.getItem('login-type')!='TRAVELLER')
            {
            ...
            <Drawer open={this.state.left} onClose={this.toggleDrawer('left', false)}>
                ...
                <br/>
                    <List component="nav">
                        ...
                        <ListItem button>  
                            <Link className="redirector" to="/traveller/questions"><i className="material-icons">question_answer</i></Link><span className="leftMenuItem"><Link className="redirector" to="/traveller/questions">Q & A</Link></span>
                        </ListItem>
