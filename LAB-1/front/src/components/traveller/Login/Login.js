...
class TravellerLogin extends Component {
    ...
    onSubmit(values) {
        ...
        this.props.checkLogin(values, () => {
            ...
            try
                    {
                        let s = r.payload.payload.data;//JSON.parse(response.data);
                        console.log(s);
                        if(s["code"]=="-1")
                        {
    ...
    renderField(field) {
        ...
        return (
          <div className={className}>
            ...
            <input className="form-control commonInputs" {...field.input} {...field} />
                        ...
                        <div className="col col-lg-5 text-center" style={lowerMargin}>
                            ...
                            <div className="col-lg-8 offset-lg-2 ">
                                <div className="loginBox">
                                    ...
                                    <form style={loginFormStyle} onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                                        <Field
                                        ...
                                        type="password"
                                        name="loginpassword"
                                        className="form-control commonInputs"
                                        component={this.renderField}
                                        placeholder="Password"
                                        />
                                        {/* <div className="form-group">
                                            <input type="email" className="form-control commonInputs" id="loginemail" name="loginemail" placeholder="Email address"  />
                                        </div> */}
                                        {/* <div className="form-group">
                                            <input type="password" className="form-control commonInputs" id="loginpassword" name="loginpassword" placeholder="Password" />

                                        </div> */}
                                        <a style={forgotPasswordText} href="javascript:void(0)" >Forgot Password?</a>

                                        <button type="submit" className="btn btn-primary btn-lg btn-block loginButton"  >Log In</button>
...
function validate(values) {
    ...
    if (!values.loginemail) {
      errors.loginemail = "Enter an ID";
    }
    if (!values.loginpassword) {
      errors.loginpassword = "Enter Title";
    }
...
/*   function mapStateToProps(state) {
     // console.log("sttt-------");
    console.log("state",state.check_login_details);
    return {
        state
    };
  }
...
export default reduxForm({
    validate,
    form: "NewBookForm"
  })(connect(null, { checkLogin })(TravellerLogin));
