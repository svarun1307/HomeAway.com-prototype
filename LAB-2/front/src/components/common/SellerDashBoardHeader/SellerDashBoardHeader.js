...
class SellerDashBoardHeader extends React.Component {
    ...
    constructor(props)
    {
        ...
        {
            if(sessionStorage.getItem('login-type')!='SELLER')
            {
    ...
    render() {
        console.log(sessionStorage.getItem('trcker'));



        let shouldRedirect = null;
        let userTypedMenu = null;
        if(!sessionStorage.getItem('trcker') || !sessionStorage.getItem('isLogged'))
        {
            console.log("yes");
            shouldRedirect = ( <Redirect to="/seller-login" /> );
        }
        else 
        {
            console.log("no");
        ...
        else if(sessionStorage.getItem('login-type')=='TRAVELLER')
        {
            ...
            <Drawer open={this.state.left} onClose={this.toggleDrawer('left', false)}>
                ...
                <br/>
                    <List component="nav">
                        ...
                        <ListItem button>  
                            <Link className="redirector" to="/seller/dashboard"><i className="material-icons">home</i></Link><span className="leftMenuItem"><Link className="redirector" to="/seller/dashboard">Dashboard</Link></span>
                        </ListItem>
                        {
                        userTypedMenu == 'SELLER' ? 
                        <ListItem button>  
                        ...
                        <ListItem button>  
                            <Link className="redirector" to="/seller/bookings"><i className="material-icons">flash_on</i></Link><span className="leftMenuItem"><Link className="redirector" to="/seller/bookings">My Bookings</Link></span>
                        </ListItem>
                        <ListItem button>  
                            <Link className="redirector" to="/seller/user-profile"><i className="material-icons">person</i></Link><span className="leftMenuItem"><Link className="redirector" to="/seller/user-profile">My Profile</Link></span>
                        </ListItem>

                        <ListItem button>  
                            <Link className="redirector" to="/seller/questions"><i className="material-icons">question_answer</i></Link><span className="leftMenuItem"><Link className="redirector" to="/seller/questions">Q & A</Link></span>
                        </ListItem>
...
power_settings_new
                            ...
                            >
                               <MenuItem onClick={this.handleClose}> <Link className="redirector" to="/seller/user-profile">Profile </Link></MenuItem>
                            {
                            ...
                            {
                                <MenuItem onClick={this.handleClose}><Link className="redirector" to="/seller/bookings">My Bookings</Link> </MenuItem> 
                            }       
