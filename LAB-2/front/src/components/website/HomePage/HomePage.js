...
import {getLoginDetails, savePropertyDetails} from '../../../actions/index'
...
class HomePage extends React.Component {
    ...
    {   
        ...
        let u = {
            ...
            skip : 0,
            limit :  PAGINATION_FACTOR//Change this to change number of propertyies being loaded at once.
        };
        ...
        /* axios.post(BASE_URL+'/search-data',u ,
                { 
                ...
                if(response.status === 200){
                    ...
                    try
                    {
                        ...
                        else if(s.code == '+1')
                        {
                            ...
                            this.props.dispatch(savePropertyDetails({ passedData: response.data , dateData : u  }));
